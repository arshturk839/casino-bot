...
import requests
from config import TELEGRAM_TOKEN, CREATE_ID_URL, DEPOSIT_URL, WITHDRAW_URL, BALANCE_URL, STATIC_UPI_ID
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Welcome to the Casino Bot 🎰", reply_markup=menu_keyboard)
